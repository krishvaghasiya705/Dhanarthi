    ...
    const Blogdata = [
        {
            ...
            blogtitle: "What is Backtesting and How Do You Backtest a Trading Strategy?",
            blogdetail: "Backtesting evaluates a trading strategy using historical data to assess performance before applying it to live markets...."
        },
        {
            Blogimage: Blogimage2,
            blogdate: "Mar 13, 2025",
            blogtitle: "NSE Holiday List 2025",
            blogdetail: "NSE holidays are designated non-trading days when the National Stock Exchange remains closed. These include national holidays, festivals..."
        },
        {
            Blogimage: Blogimage3,
            blogdate: "Mar 13, 2025",
            blogtitle: "What is a Stockbroker? A Complete Guide",
            blogdetail: "A stockbroker is a licensed professional who buys and sells stocks on behalf of clients, providing market insights and advice...."
        }
    ]
  return (
        ...
        <div className={styles.ltsblogcardgrd}>
            {Blogdata.map((i) => (
                <div className={styles.ltsblogcardmain}>
                    ...
                    <span className={styles.bloglink}>Read More <Arrow /></span>
                    </div>
                </div>
            ))}
        </div>
